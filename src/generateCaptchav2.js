module.exports = function(configIn = {}) {
    ...
    let shapes = configIn.shapes || Math.random()*200; // Math.random()*200;
    let shapesSizeMultiplier = configIn.shapesSizeMultiplier || 80
    ...
    // ## Warp the text
    ctx.save();
    ctx.translate(genRandom(60, width-fontsize*charLength*0.8), genRandom(20, height-fontsize-20));
    ctx.rotate(genRandom(rotatemin/90, rotatemax/90));
